...
.directive('ngDatepicker', ['$document', function($document) {
	...
	return {
		...
		template: 
		'<div class="right-inner-addon "><i class="fa fa-calendar"></i><input type="text" ng-focus="showCalendar()" ng-readonly="true" ng-value="viewValue" class="ng-datepicker-input form-control" placeholder="{{ placeholder }}"></div>'+
